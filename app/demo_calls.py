...
class CallSimulator:
    ...
    async def create_demo_calls(self, count: int = 10):
        ...
        for i in range(count):
            ...
            caller = f"+1555{random.randint(1000, 9999)}"
            callee = f"+1555{random.randint(1000, 9999)}"
            
            # Random start time in the last 7 days
            start_time = time.time() - random.randint(0, 7 * 24 * 3600)
            ...
            call_item.update_audio_quality({
                ...
                "mos_score": random.uniform(3.0, 5.0)
            })
    ...
    async def simulate_live_calls(self, duration_minutes: int = 5):
        ...
        while self.running and time.time() < end_time:
            ...
            call_item.update_audio_quality({
                ...
                "mos_score": random.uniform(4.0, 5.0)
            })
